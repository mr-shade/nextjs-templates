  ...
  return (
    <>
      <div>
        <div
          role='status'
          className='max-w-md animate-pulse overflow-hidden p-8 relative rounded-2xl bg-linear-to-b from-primary/10 to-white shadow-md'>
          <svg
            className='w-30 h-30 mx-auto text-bluegray/20 my-5'
            aria-hidden='true'
