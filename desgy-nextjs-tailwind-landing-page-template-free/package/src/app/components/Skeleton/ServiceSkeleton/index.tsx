  ...
  return (
    <>
      <div>
        <div
          role='status'
          className='max-w-md animate-pulse overflow-hidden bg-white rounded-2xl lg:-ml-32 p-6 shadow-md bg-linear-to-b from-primary/10 to-white'>
          <svg
            className='w-10 h-10 text-bluegray/20 my-5'
            aria-hidden='true'
